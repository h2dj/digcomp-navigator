...
export const digcompAreas: DigcompArea[] = [
  {
    ...
    competencies: [
      ...
      },
      {
        ...
        prompts: [
          "기후·환경에 관한 온라인 정보를 볼 때, 누가 만들었고 어떤 근거가 있는지 확인해 믿을 만한 정보인지 판단할 수 있다.",
  ...
  },
  {
    ...
    competencies: [
      ...
      },
      {
        ...
        prompts: [
          "다양한 온라인 협업 도구를 이용하여 팀원과 공동 작업을 할 수 있다",
    ...
    competencies: [
      {
        ...
        prompts: [
          "환경 캠페인의 목표와 대상에 맞춰 카드뉴스, 숏폼, 뉴스레터 등 다양한 형식 중에서 선택하여 제작할 수 있다.",
      ...
      },
      {
        ...
        prompts: [
          "자료 공유 시 저작권 여부를 확인하고 제반 규범을 준수할 수 있다",
    ...
    competencies: [
      {
        ...
        prompts: [
          "보안이 필요한 업무 계정에 강력한 비밀번호와 다중 인증을 설정할 수 있다.",
      ...
      },
      {
        ...
        prompts: [
          "설문이나 후원 신청에서 불필요한 개인정보를 수집하지 않도록 설계할 수 있다.",
      ...
      },
      {
        ...
        prompts: [
          "알림을 끄거나 회의·메신저 시간을 조절해, 방해받지 않고 집중할 시간을 만들 수 있다.",
    ...
    competencies: [
      {
        ...
        prompts: [
          "컴퓨터, 스마트폰 등 이용 중인 기기에서 문제가 생겼을 때 원인을 파악해 해결책을 찾아볼 수 있다.",
      ...
      },
      {
        ...
        prompts: [
          "문제해결을 위해 조직의 여건에 맞는 디지털 솔루션을 찾아보고 도입을 제안할 수 있다.",
      ...
      },
      {
        ...
        prompts: [
          "디지털 기술을 활용해 기존의 비효율적 방식을 개선 및 변화한 경험이 있고, 관련한 새로운 아이디어를 팀에 제안할 수 있다.",
